...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/06/03 11:43:34 by jadelgad          #+#    #+#             */
/*   Updated: 2026/06/03 11:43:40 by jadelgad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (argc != 2)
		return (print_error("Wrong num of args"), 1);
	*map_file = argv[1];
	if (!check_extension(*map_file))
		return (print_error("No valid extension"), 1);
	return (0);
}
